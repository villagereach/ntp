...
default['ntp']['servers']   = ["0.north-america.pool.ntp.org", "1.north-america.pool.ntp.org", "2.north-america.pool.ntp.org", "3.north-america.pool.ntp.org", ] # The default recipe sets a list of common NTP servers (COOK-1170)
default['ntp']['peers'] = []
